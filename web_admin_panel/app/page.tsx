    ...
    <div className="admin-layout">
      ...
      <main className="content-shell">
        ...
        <section className="debug-strip">
          buildVersion: {debug.buildVersion}, warning: {debug.warning || "-"}, dropdownBranches: [{debug.dropdownBranches.join(", ")}], activeBranchKeys: {JSON.stringify(debug.activeBranchKeys)}, blockedBranchKeys: {JSON.stringify(debug.blockedBranchKeys)}, inactiveBranchKeys: {JSON.stringify(debug.inactiveBranchKeys)}, sampleCustomerBranchKeys: {JSON.stringify(debug.sampleCustomerBranchKeys)}, sampleProductBranchKeys: {JSON.stringify(debug.sampleProductBranchKeys)}, raw/active users: {numberText(debug.rawUsersCount)}/{numberText(debug.activeUsersCount)}, cashierCandidates: {JSON.stringify(debug.cashierCandidates)}, rejectedCashiers: {JSON.stringify(debug.rejectedCashiers)}, API customers: {numberText(debug.apiCustomers)}, products: {numberText(debug.apiProducts)}, sales: {numberText(debug.apiSales)}, customers before/after: {numberText(debug.customersBefore)}/{numberText(debug.customersAfter)}, products before/after: {numberText(debug.productsBefore)}/{numberText(debug.productsAfter)}, unmatched: {numberText(debug.unmatchedCustomers)}/{numberText(debug.unmatchedProducts)}, selectedKey: {debug.selectedKey}
        </section>
